...
namespace SwapWorkWebSite.Controllers
{
    ...
    {
        private readonly SwapWorkWebSiteContext _context;

        public UsersController(SwapWorkWebSiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'SwapWorkWebSiteContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SwapWorkWebSiteContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
